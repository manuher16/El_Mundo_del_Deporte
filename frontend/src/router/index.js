...
const routes = [
  ...
  {
    path: '/deporte-extremos',
    name: 'Legal',
    component: () => import('../views/ExtremeSports.vue')
  },
  {
    path: '/about',
    name: 'About',
  ...
  {
    path: '/recreacion-empresas',
    name: 'Recreation',
    component: () => import(/* webpackChunkName: "about" */ '../views/RecreationCompanies.vue')
  },
  {
    path: '/:service',
    name: 'Services',
